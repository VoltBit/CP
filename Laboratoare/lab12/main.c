...
int afisare_selectiva(DB *ag)
{
  int nr,s[8],i;
  Pers  *persoane, nr;
  printf("Numar coloane: "); scanf("%i",&nr); printf("\n");
  printf("Selectie coloane(1-7): "); printf("\n");
  for(i=0;i<nr;i++)
  {
    printf("Col[%i]: ",i+1); 
    scanf("%i",&s[i]);
  }
  *persoane = ag->vect_pers;
  nr = ag->nr_pers_curent;
}
