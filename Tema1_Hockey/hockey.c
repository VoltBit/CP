...
/*nu se specifica valorile intre care ese dat unghiul alfa, asa ca trebuie
  adus in intervalul 0-360 cu care algoritmul lucreaza*/
void data_reader(punct teren[4], punct poarta[4], double *x, double *y, double *alfa)
{
    ...
    scanf("%lg",&b); *y = b;
    scanf("%lg",&al); *alfa = al;
    //unghiul este adus in intervalul [0,360) in cazul in care nu este deja
